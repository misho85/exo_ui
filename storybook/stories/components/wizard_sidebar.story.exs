defmodule Storybook.Components.WizardSidebar do
  ...
  def render(assigns) do
    ...
    <div style="padding: 1rem; display: flex; gap: 3rem; flex-wrap: wrap;">
      <div>
        <p style="margin-bottom: 1rem; font-size: 0.875rem; color: var(--exo-muted-foreground);">Step 2 of 4</p>
      ...
      <div>
        <p style="margin-bottom: 1rem; font-size: 0.875rem; color: var(--exo-muted-foreground);">All completed</p>
        <ExoUI.Components.wizard_sidebar steps={[
