defmodule Storybook.Components.EmptyState do
  ...
  def render(assigns) do
    ...
    <div style="padding: 1rem; display: flex; flex-direction: column; gap: 2rem;">
      <ExoUI.Components.empty_state icon="📭" title="No messages" subtitle="You don't have any messages yet." />

      <ExoUI.Components.empty_state icon="🔍" title="No results found" subtitle="Try adjusting your search or filters.">
        <:action>
