defmodule Storybook.Components.Recipes do
  ...
  def entry("async_save_workflow"), do: [name: "Async Save Workflow", index: 4]
  def entry("command_routing_workflow"), do: [name: "Command Routing Workflow", index: 5]
  def entry("saved_filters_workflow"), do: [name: "Saved Filters Workflow", index: 6]
end
