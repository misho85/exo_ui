defmodule Storybook.Components.Avatar do
  ...
  def render(assigns) do
    ...
    <div style="padding: 1rem; display: flex; flex-direction: column; gap: 2rem;">
      <div>
        <p style="font-size: 0.75rem; font-weight: 600; color: var(--exo-muted-foreground); text-transform: uppercase; letter-spacing: 0.05em; margin-bottom: 0.75rem;">Sizes</p>
      ...
      <div>
        <p style="font-size: 0.75rem; font-weight: 600; color: var(--exo-muted-foreground); text-transform: uppercase; letter-spacing: 0.05em; margin-bottom: 0.75rem;">With image</p>
        <div style="display: flex; gap: 1rem; align-items: center;">
      ...
      <div>
        <p style="font-size: 0.75rem; font-weight: 600; color: var(--exo-muted-foreground); text-transform: uppercase; letter-spacing: 0.05em; margin-bottom: 0.75rem;">Group</p>
        <div style="display: flex;">
          <ExoUI.Components.avatar name="Alice Smith" size="md" />
          <div style="margin-left: -0.5rem;"><ExoUI.Components.avatar name="Bob Jones" size="md" /></div>
          <div style="margin-left: -0.5rem;"><ExoUI.Components.avatar name="Charlie Brown" size="md" /></div>
          <div style="margin-left: -0.5rem;"><ExoUI.Components.avatar name="Diana Prince" size="md" /></div>
        </div>
      </div>
    </div>
    """
