defmodule Storybook.Components.Forms do
  ...
  def entry("date_picker"), do: [name: "Date Picker", index: 5]
  def entry("file_input"), do: [name: "File Input", index: 6]
  def entry("radio_group"), do: [name: "Radio Group", index: 7]
  def entry("rating"), do: [name: "Rating", index: 8]
  def entry("slider"), do: [name: "Slider", index: 9]
end
