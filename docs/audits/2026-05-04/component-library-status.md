...
| Component-mode stories | 32 component stories, 1 live component story, 53 page-mode stories still to convert |
| Playwright component capture | 84 Storybook routes captured |
| Capture artifacts | 84 screenshots, 84 WebM videos, 84 MP4 videos |
| Latest capture | `output/playwright/exo-ui-components/2026-05-05T00-17-27-969Z/viewer.html` |
...
1. Continue converting the remaining 53 page-mode Storybook examples to component-mode stories where PhoenixStorybook can expose attrs, slots, playground controls, and source examples.
...
- `bun run capture:components` -> 84 entries, 0 failed, 84 MP4 conversions in `output/playwright/exo-ui-components/2026-05-05T00-17-27-969Z`.
