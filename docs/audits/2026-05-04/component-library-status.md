...
| Latest capture | `output/playwright/exo-ui-components/2026-05-04T18-21-53-409Z/viewer.html` |
...
| Forms | Phoenix FormField integration is now strong across most controls, and select/combobox expose active-descendant keyboard state | Combobox loading/empty states can still add live-region polish |
...
3. Improve combobox loading/empty live-region announcements and document the keyboard interaction model.
...
- `bun run capture:components` -> 83 entries, 0 failed, 83 MP4 conversions in `output/playwright/exo-ui-components/2026-05-04T18-21-53-409Z`.
