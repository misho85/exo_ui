...
| Latest capture | `output/playwright/exo-ui-components/2026-05-06T15-49-00-101Z/viewer.html` |
| Browser suite | 95 Playwright tests passing |
| ExUnit suite | 527 tests passing |
...
- `bun run capture:components` -> 114 entries, 0 failed, 114 MP4 conversions in `output/playwright/exo-ui-components/2026-05-06T15-49-00-101Z`.
